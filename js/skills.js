...
skills = [
    ...
    "desc":`C was and always will be my first and favorite programming language, and gave me a strong understanding of memory at the hardware/software interface.`},
    {"name":"Volatility","tags":["grid-item","forensics"],"img":"./images/icons8-detective-64.png",
    "desc":`For memory forensics.`},
    ...
    "desc":`Familiar with deployment architecture, logging pipelines and datamodels, custom app development and detection rule creation focussed around the Enterprise Security suite of tools.`},

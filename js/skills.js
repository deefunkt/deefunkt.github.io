...
skills = [
    ...
    "desc":`Familiar with the Windows API, low level data structures and process heirarchies for the purposes of malware analysis.`},
    {"name":"Linux internals","tags":["grid-item","mtrx","rev-eng","forensics"],"img":"./images/icons8-linux-48.png",
    "desc":`Familiar with system internals, configuration, and the ELF binary format, though not as much as with low level Windows structures.`},
    ...
    "desc":`Currently learning to work with Ghidra.`},
